  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {/* Цвет не трогаем намеренно: янтарные токены (`warning-*`) были нечитаемы на
            шампани светлой темы (РС-14д); темы больше нет, но заметность здесь даёт не цвет,
            а знак в начале строки (так же, как в чате) и сменившаяся главная кнопка. */}
