...
const SPEAKS_ABOUT_US_SUBSTRINGS: Record<string, string[]> = {
  'zh.json': ['我们'],
  // fa: глагол первого лица мн. ч. — окончание «‑یم». Берём формы, реально стоявшие в снятой
  // редакции; соседние верные строки используют второе лицо («کرده بودید») и не задеты.
  'fa.json': ['نکردیم', 'کردیم'],
};
